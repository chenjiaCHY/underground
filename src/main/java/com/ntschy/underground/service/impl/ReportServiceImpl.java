                ...
                if (!CollectionUtils.isEmpty(geomList)) {
                    for (String geom : geomList) {
                        if (geom.startsWith("MULTILINESTRING")) {
                            ...
                            dxfGraphics.drawLine(Double.valueOf(linePointList[0]) - 592000,
                                    Double.valueOf(linePointList[1]) -3532000,
                                    Double.valueOf(linePointList[2]) - 592000,
                                    Double.valueOf(linePointList[3]) - 3532000);
                        }
                        ...
                        if (geom.startsWith("POINT")) {
                            ...
                            dxfGraphics.drawPoint(Double.valueOf(pointPointList[0]) - 592000, Double.valueOf(pointPointList[1]) - 3532000);
                        }
                    }
                }
            }
